<?php
/**
 * saudi_woman functions and definitions
 *
...
if ( ! function_exists( 'saudiwomans_setup' ) ) :
	/**
	 ...
	 */
	function saudiwomans_setup() {
		/*
		 * Make theme available for translation.
		 * Translations can be filed in the /languages/ directory.
		 * If you're building a theme based on saudi_woman, use a find and replace
		 * to change 'saudiwomans' to the name of your theme in all the template files.
		 */
		load_theme_textdomain( 'saudiwomans', get_template_directory() . '/languages' );
   	...
   	//	add_theme_support( 'title-tag' );
        ...
        function saudiwomans_register_custome_menu(){ 
			register_nav_menus( array(
                'main menu' => 'Navigation Menu',
                'second menu' => 'footer Menu'
            ));
		}
        add_action('init','saudiwomans_register_custome_menu');
		...
		add_theme_support( 'custom-background', apply_filters( 'saudiwomans_custom_background_args', array(
...
add_action( 'after_setup_theme', 'saudiwomans_setup' );
 ...
 */
function saudiwomans_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'saudiwomans_content_width', 640 );
}
add_action( 'after_setup_theme', 'saudiwomans_content_width', 0 );
 ...
 */
function saudiwomans_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'saudiwomans' ),
		'id'            => 'sidebar-1',
		'description'   => esc_html__( 'Add widgets here.', 'saudiwomans' ),
...
add_action( 'widgets_init', 'saudiwomans_widgets_init' );

/**
* Enqueue styles
*/
function saudiwomans_add_styles(){
...
add_action('wp_enqueue_scripts','saudiwomans_add_styles');

/**
 * Enqueue scripts
 */
function saudiwomans_add_scripts(){
...
add_action('wp_enqueue_scripts','saudiwomans_add_scripts');

// add google map key

function my_acf_google_map_api( $api ){
	
	$api['key'] = 'AIzaSyBfYrUtLhxKplDScjw7Pa124rwoMdSrp6A';
